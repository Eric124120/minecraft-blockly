    ...
    */
    ...
    init: function() {   
        ...
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldCheckbox('FALSE', null, null), 'SCALE'); 
        this.setInputsInline(true);         
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null); 
        this.setColour(120);
    ...
    */
    ...
    init: function() {
        ...
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldCheckbox('FALSE', null, null), 'DELAY'); 
        this.setInputsInline(true);         
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setColour(0);
    ...
    init: function() { 
        ...
        this.appendDummyInput()
            .appendField('in bold')
            .appendField(new Blockly.FieldCheckbox('FALSE', null, null), 'BOLD'); 
            
        this.appendDummyInput()
            .appendField('in italic')
            .appendField(new Blockly.FieldCheckbox('FALSE', null, null), 'ITALIC');  
    ...
    this.appendDummyInput()
            .appendField('flicker')
            .appendField(new Blockly.FieldCheckbox('FALSE', null, null), 'FLICKER');                                                                                               
